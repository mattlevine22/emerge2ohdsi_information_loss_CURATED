...
-- Intent1a
drop table my_codes_sno_ke_gh_optimal_1a;
create table my_codes_sno_ke_gh_optimal_1a as
select distinct concept_id
from public.concept
where concept_id IN (
0
...
-- Intent1b
drop table my_codes_sno_ke_gh_optimal_1b;
create table my_codes_sno_ke_gh_optimal_1b as
select distinct concept_id
from public.concept
where concept_id IN (
74125
...
-- Intent1c
drop table my_codes_sno_ke_gh_optimal_1c;
create table my_codes_sno_ke_gh_optimal_1c as
select distinct concept_id
from public.concept
where concept_id IN (
4291025
...
-- Intent1d
drop table my_codes_sno_ke_gh_optimal_1d;
create table my_codes_sno_ke_gh_optimal_1d as
select distinct concept_id
from public.concept
where concept_id IN (
74125,
...
-- Intent2a
drop table my_codes_sno_ke_gh_optimal_2a;
create table my_codes_sno_ke_gh_optimal_2a as
select distinct concept_id
from public.concept
where concept_id IN (
80809,
...
-- Intent2b
drop table my_codes_sno_ke_gh_optimal_2b;
create table my_codes_sno_ke_gh_optimal_2b as
select distinct concept_id
from public.concept
where concept_id IN (
80809,
...
-- Intent2c
drop table my_codes_sno_ke_gh_optimal_2c;
create table my_codes_sno_ke_gh_optimal_2c as
select distinct concept_id
from public.concept
where concept_id IN (
80809,
...
-- Intent2d
drop table my_codes_sno_ke_gh_optimal_2d;
create table my_codes_sno_ke_gh_optimal_2d as
select distinct concept_id
from public.concept
where concept_id IN (
80809,
